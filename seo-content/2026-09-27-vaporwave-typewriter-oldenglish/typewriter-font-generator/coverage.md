# Coverage QA — "typewriter font generator"
...
**Flags for the user**:
- thewordfinder.com returned 403 — substituted font-generator.com.
- Courier/Kettler/IBM/1955 from Wikipedia "Courier (typeface)".
